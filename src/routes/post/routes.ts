...
import { createPostValidationRules, validate, updateValidationRules } from '../../middleware/validation/validator'
...
PostRouter.put('/update/:postId', updateValidationRules(), validate, updatePostHandler)  
